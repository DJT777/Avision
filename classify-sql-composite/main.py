...
model = tf.keras.models.load_model('/home/dylan/Desktop/data_science_work/working-dir/saved-models/Composite-VGG16-model_fine_tuned')
try:
        ...
        #get class list
        class_array = os.listdir('/home/dylan/Desktop/data_science_work/datasets/Composite Classifier')
        class_array.sort()
        print(class_array)
